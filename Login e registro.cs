...
// verificar se no login bate com o registrado.
    ...
    while (escolha == "registrar" || escolha == "Registrar" || escolha == "Registrar-se" || escolha == "registrar-se")
    {
        Console.Clear();
        Console.WriteLine("===========");
    ...
    if (confirmar == "sim" || confirmar == "Sim" || confirmar == "S" || confirmar == "s" || escolha == "logar" || escolha == "Logar" || escolha == "logar-se" || escolha == "Logar-se" || escolha == "login" || escolha == "Login")
    {
        Console.Clear();
        Console.WriteLine("===========");
